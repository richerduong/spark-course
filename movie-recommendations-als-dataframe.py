...
def loadMovieNames():
    ...
    with codecs.open("E:/Users/steam/repos/spark-course/ml-100k/u.ITEM", "r", encoding='ISO-8859-1', errors='ignore') as f:
        for line in f:
            fields = line.split('|')
...
ratings = spark.read.option("sep", "\t").schema(moviesSchema) \
    .csv("file:///Users/steam/repos/spark-course/ml-100k/u.data")
